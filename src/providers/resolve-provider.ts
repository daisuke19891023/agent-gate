...
import type { ContainerProvider, RuntimeProviderKind, RuntimeProviderPreference } from "./types.js";
...
async function defaultAvailabilityCheck(command: "docker" | "podman"): Promise<boolean> {
  try {
